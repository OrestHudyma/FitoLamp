...
export LoadConfig_fitolamp_slave
...
;---------------------------------------------------------------------------
; Load Configuration fitolamp_slave
;
;    Load configuration registers for fitolamp_slave.
...
;               CUR_PP
;
_LoadConfig_fitolamp_slave:
 LoadConfig_fitolamp_slave:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_fitolamp_slave_Bank0
    mov     X, <LoadConfigTBL_fitolamp_slave_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_fitolamp_slave_Bank1
    mov     X, <LoadConfigTBL_fitolamp_slave_Bank1
