...
include "m8c.inc"
include "PWM16_CH0.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM16_CH0_EnableInt
export _PWM16_CH0_EnableInt
export  PWM16_CH0_DisableInt
export _PWM16_CH0_DisableInt
export  PWM16_CH0_Start
export _PWM16_CH0_Start
export  PWM16_CH0_Stop
export _PWM16_CH0_Stop
export  PWM16_CH0_WritePeriod
export _PWM16_CH0_WritePeriod
export  PWM16_CH0_WritePulseWidth
export _PWM16_CH0_WritePulseWidth
export  PWM16_CH0_wReadPulseWidth
export _PWM16_CH0_wReadPulseWidth
export  PWM16_CH0_wReadCounter
export _PWM16_CH0_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wPWM16_CH0_ReadPulseWidth    ; deprecated
export _wPWM16_CH0_ReadPulseWidth    ; deprecated
export  wPWM16_CH0_ReadCounter       ; deprecated
export _wPWM16_CH0_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM16_CH0_EnableInt
;
;  DESCRIPTION:
...
;
 PWM16_CH0_EnableInt:
_PWM16_CH0_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM16_CH0_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM16_CH0_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM16_CH0_DisableInt:
_PWM16_CH0_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM16_CH0_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM16_CH0_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM16_CH0_WritePeriod:
_PWM16_CH0_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM16_CH0_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[PWM16_CH0_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM16_CH0_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM16_CH0_WritePulseWidth:
_PWM16_CH0_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM16_CH0_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[PWM16_CH0_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM16_CH0_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM16_CH0_wReadPulseWidth:
_PWM16_CH0_wReadPulseWidth:
 wPWM16_CH0_ReadPulseWidth:                      ; this name deprecated
_wPWM16_CH0_ReadPulseWidth:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM16_CH0_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[PWM16_CH0_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM16_CH0_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM16_CH0_wReadCounter:
_PWM16_CH0_wReadCounter:
 wPWM16_CH0_ReadCounter:                         ; this name deprecated
_wPWM16_CH0_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[PWM16_CH0_COMPARE_MSB_REG]       ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[PWM16_CH0_COMPARE_LSB_REG]       ;
   push  A                                          ;  -stack frame now 2 bytes-
   PWM16_CH0_Stop_M                              ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[PWM16_CH0_INPUT_LSB_REG]         ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[PWM16_CH0_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[PWM16_CH0_COUNTER_MSB_REG]       ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[PWM16_CH0_COMPARE_MSB_REG]       ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[PWM16_CH0_COUNTER_LSB_REG]       ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[PWM16_CH0_COMPARE_LSB_REG]       ; Stash the Count LSB on the stack
   ...
   mov   reg[PWM16_CH0_INPUT_LSB_REG], A         ;    and restore it
   M8C_SetBank0                                     ;
   PWM16_CH0_Start_M                             ; Now re-enable the PWM function
